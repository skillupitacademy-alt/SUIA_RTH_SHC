...
function CertificateCanvas({
  ...
  branding: PremiumCertificateProps["branding"];
  data: PremiumCertificateProps["data"];
  certificateRef?: PremiumCertificateProps["certificateRef"];
  withShadow: boolean;
}) {
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "#ffffff",
        borderRadius: 10,
        boxShadow: withShadow ? "0 32px 70px rgba(15, 23, 42, 0.18)" : "none",
        overflow: "hidden",
