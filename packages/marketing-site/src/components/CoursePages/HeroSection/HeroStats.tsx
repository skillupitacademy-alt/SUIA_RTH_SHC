      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex justify-center mb-4">
            <div
              className="p-4 rounded-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg"
              style={{ backgroundColor: "var(--brand-secondary)" }}
            >
          ...
          <div
            className="text-4xl md:text-5xl font-bold mb-2 text-center group-hover:scale-110 transition-transform duration-300"
