...
import { filterCoursesByCategory, isSingleCardLayout } from "@quiz/marketing-site/lib/CoursesCardData";
import { CATEGORIES, SECTION_CONFIG } from "@quiz/marketing-site/lib/CoursesCardData";
