// import { categories, categoryColors, icons, learningPaths } from "@quiz/marketing-site/lib/LearningPathData";
import { categories, categoryColors, icons, learningPaths } from "@quiz/marketing-site/lib/LearningPath";
