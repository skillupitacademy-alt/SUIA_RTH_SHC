...
export class QuestionAdminClient {
  ...
  async updateDomain(id: string, data: Partial<DomainPayload>) {
    return this.client.patch<Domain, Partial<DomainPayload>>(
      `/admin/domains/${id}`,
      data
    );
  }
  ...
  async batchDeleteDomains(ids: string[]) {
    return this.client.post<AdminSuccessResponse>(
  ...
  async getSubjects(
    ...
    return this.client.get<PaginatedResponse<Subject>>(
  ...
  async updateSubject(id: string, data: Partial<SubjectPayload>) {
    return this.client.patch<Subject, Partial<SubjectPayload>>(
      `/admin/subjects/${id}`,
      data
    );
  }
  ...
  async getTopics(
    ...
    return this.client.get<PaginatedResponse<Topic>>(
  ...
  async updateTopic(id: string, data: Partial<TopicPayload>) {
    return this.client.patch<Topic, Partial<TopicPayload>>(
      `/admin/topics/${id}`,
      data
    );
  }
  ...
  async getSubtopics(
    ...
    return this.client.get<PaginatedResponse<Subtopic>>(
      `/admin/subtopics?${query.toString()}`
    );
  }

  async createSubtopic(data: SubtopicPayload) {
    return this.client.post<Subtopic, SubtopicPayload>(
      '/admin/subtopics',
      data
    );
  }
  ...
  async updateSubtopic(id: string, data: Partial<SubtopicPayload>) {
    return this.client.patch<Subtopic, Partial<SubtopicPayload>>(
      `/admin/subtopics/${id}`,
      data
    );
  }
  ...
  async updateSkill(id: string, data: Partial<SkillPayload>) {
    return this.client.patch<Skill, Partial<SkillPayload>>(
      `/admin/skills/${id}`,
      data
    );
  }
  ...
  async getQuestions(
    ...
    if (filters?.subjectId != null && filters.subjectId !== '')
      query.append('subjectId', filters.subjectId);
    if (filters?.topicId != null && filters.topicId !== '')
      query.append('topicId', filters.topicId);
    if (filters?.subtopicId != null && filters.subtopicId !== '')
      query.append('subtopicId', filters.subtopicId);
    ...
    return this.client.get<PaginatedQuestions>(
  ...
  async createQuestion(data: QuestionPayload) {
    return this.client.post<QuestionSummary, QuestionPayload>(
      '/admin/questions',
      data
    );
  }
  ...
  async bulkCreateQuestions(data: {
    ...
    return this.client.post<{ questions: QuestionSummary[] }, typeof data>(
  ...
  async updateQuestion(id: string, data: Partial<QuestionPayload>) {
    return this.client.patch<QuestionSummary, Partial<QuestionPayload>>(
      `/admin/questions/${id}`,
      data
    );
  }
  ...
  async atomicSeed(data: Record<string, unknown>) {
    return this.client.post<Record<string, unknown>, Record<string, unknown>>(
      '/admin/hierarchy/atomic',
      data
    );
  }

  async saveFactoryBatch(data: FactoryBatchPayload) {
    return this.client.post<Record<string, unknown>, FactoryBatchPayload>(
      '/factory/save',
      data
    );
  }
  ...
  async checkDuplicates(data: {
    ...
    return this.client.post<DuplicateCheckResponse>(
