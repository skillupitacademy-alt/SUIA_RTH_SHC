...
export const PlatformEventPayloadSchemas = {
  ...
  [PlatformEventTypes.SESSION_SCHEDULED]: idPayload({
    batchId: z.string().uuid(),
...
export const PlatformEventEnvelopeSchemas = {
  ...
  [PlatformEventTypes.SESSION_SCHEDULED]: z.object({ ...baseFields, type: z.literal(PlatformEventTypes.SESSION_SCHEDULED), data: PlatformEventPayloadSchemas[PlatformEventTypes.SESSION_SCHEDULED] }),
