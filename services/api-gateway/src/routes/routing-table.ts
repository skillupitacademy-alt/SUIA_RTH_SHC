...
export const ROUTING_TABLE: GatewayRoute[] = [
  ...
  { host: 'user.realtutorialhub.com', prefix: '/profile', upstreamKey: 'EXAM_SERVICE_URL', upstreamPathPrefix: '/api/auth/profile', auth: true },
  { host: 'user.realtutorialhub.com', prefix: '/dashboard', upstreamKey: 'EXAM_SERVICE_URL', upstreamPathPrefix: '/api/dashboard', auth: true },
  ...
  { host: 'user.skillupitacademy.com', prefix: '/profile', upstreamKey: 'EXAM_SERVICE_URL', upstreamPathPrefix: '/api/auth/profile', auth: true },
  { host: 'user.skillupitacademy.com', prefix: '/dashboard', upstreamKey: 'EXAM_SERVICE_URL', upstreamPathPrefix: '/api/dashboard', auth: true },
  ...
  { host: 'api.realtutorialhub.com', prefix: '/health/live', upstreamKey: 'EXAM_SERVICE_URL', upstreamPathPrefix: '/api/health/live', public: true },
  { host: 'api.skillupitacademy.com', prefix: '/health/live', upstreamKey: 'EXAM_SERVICE_URL', upstreamPathPrefix: '/api/health/live', public: true },
