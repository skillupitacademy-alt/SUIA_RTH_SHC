...
export const ROUTING_TABLE: GatewayRoute[] = [
  ...
  { host: 'user.realtutorialhub.com', prefix: '/onboarding', upstreamKey: 'TUTORIAL_SERVICE_URL', upstreamPathPrefix: '/api/onboarding', auth: true },
  { host: 'user.realtutorialhub.com', prefix: '/profile', upstreamKey: 'TUTORIAL_SERVICE_URL', upstreamPathPrefix: '/api/profile', auth: true },
  ...
  { host: 'user.skillupitacademy.com', prefix: '/onboarding', upstreamKey: 'SKILLUP_WEB_URL', upstreamPathPrefix: '/api/onboarding', auth: true },
  { host: 'user.skillupitacademy.com', prefix: '/profile', upstreamKey: 'SKILLUP_WEB_URL', upstreamPathPrefix: '/api/profile', auth: true },
