...
import { Target, TrendingUp, Brain, FileEdit, Lightbulb, Award, Check, X, ArrowRight, Layers, GraduationCap } from 'lucide-react';
      ...
      <nav className="bg-white/80 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden min-[801px]:flex items-center gap-4">
            <Link href="/" className="text-gray-700 hover:text-gray-900 transition font-bold duration-300 hover:-translate-y-1">Return Home</Link>
          </div>
          <button aria-label="Toggle Navigation Menu" className="min-[801px]:hidden p-2 text-gray-700 hover:bg-gray-100 rounded-lg transition" />
        </div>
      </nav>

      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 flex flex-col lg:flex-row items-center justify-center relative z-10">
        {/* Left Content */}
        <div className="w-full lg:w-1/2 flex flex-col items-start lg:pr-10 mb-12 lg:mb-0">
          <h1 className="text-4xl sm:text-6xl md:text-7xl md:leading-tight font-bold mb-6 font-poppins tracking-tight">
            <span style={{ color: config.primaryColor }}>Enter the</span><br />
            <span style={{ color: config.secondaryColor }}>Ecosystem.</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 font-medium max-w-lg leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full sm:w-auto">
            <Link href="/login?redirect=/dashboard/exams" className="text-white px-6 py-4 sm:px-10 sm:py-4 rounded-full text-base sm:text-lg w-full sm:w-auto transition-all font-bold shadow-[0_15px_30px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)] flex items-center justify-center gap-2 hover:-translate-y-1" style={{ backgroundColor: config.primaryColor }}>
              <Target className="w-5 h-5" /> Enter Exam Engine
            </Link>
            <Link href="/login?redirect=/dashboard/tutorial" className="bg-white text-gray-800 px-6 py-4 sm:px-10 sm:py-4 rounded-full text-base sm:text-lg w-full sm:w-auto border-2 transition-all font-bold shadow-sm hover:shadow-[0_15px_30px_rgba(0,0,0,0.1)] flex items-center justify-center gap-2 hover:-translate-y-1" style={{ borderColor: config.secondaryColor }}>
        ...
        <div className="w-full lg:w-1/2 relative">
          <div className="bg-white rounded-[2rem] shadow-2xl border border-gray-100 p-4 absolute top-0 -right-10 w-full transform rotate-3 translate-y-10 z-0 opacity-50 blur-[2px] hidden md:block">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.12)] border border-gray-100 p-8 relative z-10 transition hover:-translate-y-2 duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.15)]">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16">
         ...
         <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              {/* Card 1 */}
              <div className="bg-white rounded-[1.5rem] p-6 shadow-xl border-t border-slate-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] cursor-pointer relative group">
                <div className="w-12 h-12 bg-pink-50 text-pink-600 rounded-xl flex items-center justify-center mb-4"><Target className="w-6 h-6" /></div>
              ...
              {/* Card 2 */}
              <div className="bg-white rounded-[1.5rem] p-6 shadow-xl border-t border-slate-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] cursor-pointer relative group">
                <div className="w-12 h-12 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center mb-4"><TrendingUp className="w-6 h-6" /></div>
              ...
              {/* Card 3 */}
              <div className="bg-white rounded-[1.5rem] p-6 shadow-xl border-t border-slate-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] cursor-pointer relative group">
                <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center mb-4"><Brain className="w-6 h-6" /></div>
              ...
              {/* Card 4 */}
              <div className="bg-white rounded-[1.5rem] p-6 shadow-xl border-t border-slate-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] cursor-pointer relative group">
                <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mb-4"><FileEdit className="w-6 h-6" /></div>
              ...
              {/* Card 5 */}
              <div className="bg-white rounded-[1.5rem] p-6 shadow-xl border-t border-slate-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] cursor-pointer relative group">
                <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mb-4"><Lightbulb className="w-6 h-6" /></div>
              ...
              {/* Card 6 */}
              <div className="bg-white rounded-[1.5rem] p-6 shadow-xl border-t border-slate-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] cursor-pointer relative group">
                <div className="w-12 h-12 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center mb-4"><Award className="w-6 h-6" /></div>
            ...
            <div className="mt-16">
               ...
               <div className="bg-white rounded-[2rem] p-8 shadow-2xl border border-slate-100">
                  <div className="flex justify-between items-end gap-3 sm:gap-6">
         ...
         <div className="space-y-16">
            ...
            <div>
               ...
               <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-[0_30px_60px_rgba(0,0,0,0.12)] border border-slate-100 relative group transition hover:shadow-[0_40px_80px_rgba(0,0,0,0.18)]">
                  ...
                  <div className="space-y-4">
                     <div className="flex items-center justify-between bg-rose-50/50 p-4 rounded-2xl border border-rose-100/50 transition hover:bg-rose-50">
                        <span className="text-sm font-bold text-slate-800">Linked Lists Architecture</span>
                        <span className="text-[10px] font-black text-rose-700 bg-rose-100 px-3 py-1.5 rounded-md uppercase tracking-wider">FAILED EXAM</span>
                     </div>
                     <div className="flex items-center justify-between bg-amber-50/50 p-4 rounded-2xl border border-amber-100/50 transition hover:bg-amber-50">
                        <span className="text-sm font-bold text-slate-800">Async Wait Promises</span>
                        <span className="text-[10px] font-black text-amber-700 bg-amber-100 px-3 py-1.5 rounded-md uppercase tracking-wider">WEAK DIAGNOSTIC</span>
                     </div>
                     <div className="flex items-center justify-between bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100/50 transition hover:bg-emerald-50">
                        <span className="text-sm font-bold text-slate-800">Map & Filter Recursion</span>
                        <span className="text-[10px] font-black text-emerald-700 bg-emerald-100 px-3 py-1.5 rounded-md uppercase tracking-wider">FULLY MASTERED</span>
                     </div>
                  </div>
                  <div className="mt-6 flex justify-center">
                     <span className="inline-flex items-center gap-2 text-xs font-bold text-white px-4 py-2 rounded-lg cursor-pointer transition hover:-translate-y-0.5" style={{ backgroundColor: config.primaryColor }}>
            ...
            <div>
               ...
               <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-[0_30px_60px_rgba(0,0,0,0.12)] border border-slate-100">
