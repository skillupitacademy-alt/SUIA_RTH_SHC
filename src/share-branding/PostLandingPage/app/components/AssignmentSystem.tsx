      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full mb-6">
            ...
            <span className="text-sm text-blue-800">Progressive Difficulty System</span>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {levels.map((level, idx) => {
              ...
              return (
                <div 
                  key={idx} 
                  className={`relative bg-white rounded-2xl p-8 border-2 ${level.borderColor} ${
                    isLocked ? 'bg-gray-50/50' : 'hover:shadow-xl'
                  } transition-all`}
                >
                  {isCurrent && (
                  ...
                  {isCompleted && (
                    <div className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-br from-green-600 to-green-700 rounded-full flex items-center justify-center">
