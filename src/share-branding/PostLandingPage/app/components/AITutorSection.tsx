...
export function AITutorSection() {
  ...
  return (
    <section id="mentorship" className={`py-24 bg-gradient-to-br from-purple-50 via-${accentClass}-50 to-${accentClass}-50`}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center px-4 md:px-0">
          ...
          <div className="min-w-0 w-full overflow-hidden bg-white rounded-3xl p-6 md:p-8 border border-gray-200 shadow-xl hover:shadow-[0_30px_60px_rgba(0,0,0,0.15)] hover:-translate-y-2 transition-all duration-500 cursor-default">
            <div className="space-y-4 min-w-0">
              <div className="flex items-start gap-3 min-w-0">
                <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="text-white font-semibold">You</span>
                </div>
                <div className="bg-blue-50 rounded-2xl rounded-tl-none p-4 flex-1 min-w-0">
                  <p className="text-gray-700 break-words">I don't understand how async/await works in JavaScript. Can you explain?</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 min-w-0">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl rounded-tl-none p-4 flex-1 min-w-0 overflow-hidden">
                  ...
                  <div className="bg-white rounded-lg p-3 font-mono text-sm text-gray-800 mt-3 w-full overflow-hidden">
                    <code className="block w-full whitespace-pre-wrap break-words">
  ...
  return data;
                  ...
                  <p className="text-gray-700 mt-3 break-words">
                    Would you like me to show you a real-world example?
                  </p>
                </div>
              </div>

              <div className="flex items-center justify-center gap-2 text-sm text-gray-600 pt-2 min-w-0">
                <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
                <span className="break-words">Response generated in 0.8s</span>
              </div>
            </div>
          </div>
        </div>
