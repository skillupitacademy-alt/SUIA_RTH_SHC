...
export function WelcomeHero() {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-10 pt-4">
      ...
      <div
        className="relative overflow-hidden rounded-3xl p-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
        style={{
      ...
      <div
        className="relative overflow-hidden rounded-3xl p-6 text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
        style={{
      ...
      >
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="mb-4 grid grid-cols-1 gap-3 min-[420px]:grid-cols-2">
            <div className="flex min-w-0 items-center gap-2.5 rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-sm">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="truncate text-[9px] font-bold uppercase text-white">Time</span>
              </div>
            </div>
            <div className="flex min-w-0 items-center gap-2.5 rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-sm">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="truncate text-[9px] font-bold uppercase text-white">Lessons</span>
              </div>
            </div>
            <div className="flex min-w-0 items-center gap-2.5 rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-sm">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="truncate text-[9px] font-bold uppercase text-white">Goal</span>
              </div>
            </div>
            <div className="flex min-w-0 items-center gap-2.5 rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-sm">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="truncate text-[9px] font-bold uppercase text-white">XP</span>
              </div>
            </div>
          </div>
