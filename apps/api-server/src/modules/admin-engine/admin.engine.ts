...
export class AdminEngine {
  ...
  static async createDomain(data: DomainInsert, adminId: string) { 
    ...
    await container.get(AuditService).log({ userId: adminId, action: 'admin_create_domain', metadata: { domainId: res.id } });
    return res;
  }
  ...
  static async createSubject(data: SubjectInsert, adminId: string) { 
    ...
    await container.get(AuditService).log({ userId: adminId, action: 'admin_create_subject', metadata: { subjectId: res.id } });
    return res;
  }
  ...
  static async createTopic(data: TopicInsert, adminId: string) { 
    ...
    await container.get(AuditService).log({ userId: adminId, action: 'admin_create_topic', metadata: { topicId: res.id } });
    return res;
  }
  ...
  static async createSkill(data: SkillInsert, adminId: string) { 
    ...
    await container.get(AuditService).log({ userId: adminId, action: 'admin_create_skill', metadata: { skillId: res.id } });
    return res;
  }
  ...
  static async createQuestion(data: CreateQuestionInput, adminId: string) { 
    ...
    await container.get(AuditService).log({ userId: adminId, action: 'admin_create_question', metadata: { questionId: res.id } });
    return res;
  }
  ...
  static async bulkCreateQuestionsWithContext(questions: CreateQuestionInput[], context?: Record<string, unknown>, adminId?: string) { 
    ...
    if (adminId !== undefined && adminId !== null && adminId !== '') {
        await container.get(AuditService).log({ userId: adminId, action: 'admin_bulk_create_questions', metadata: { count: res.length } });
    }
    return res;
  }
