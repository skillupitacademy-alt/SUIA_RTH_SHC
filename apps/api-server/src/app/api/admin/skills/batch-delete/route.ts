...
async function handler(_req: NextRequest) {
    try {
        ...
        const result = await AdminSkillEngine.deleteSkillsBatch(ids, payload.userId);
...
export const POST = withLogging(handler, { component: 'admin', operation: 'batch_delete_skills' });
