...
import { LaymanPromptBuilderService, type PromptGenerationRequest } from '@quiz/db-tutorial';
...
async function postHandler(req: NextRequest) {
  ...
  try {
    ...
    if (
      typeof topicName !== 'string' || topicName === '' ||
      typeof subtopicName !== 'string' || subtopicName === '' ||
    ...
    const request: PromptGenerationRequest = {
      ...
      subtopicId,
      brandId,
      difficulty: typeof difficulty === 'string' ? difficulty as 'beginner' | 'intermediate' | 'advanced' : 'beginner',
      learnerType: typeof learnerType === 'string' ? learnerType : undefined,
      promptTemplateName: typeof promptTemplateName === 'string' ? promptTemplateName : undefined,
      educationalArchitectureName: typeof educationalArchitectureName === 'string' ? educationalArchitectureName : undefined,
