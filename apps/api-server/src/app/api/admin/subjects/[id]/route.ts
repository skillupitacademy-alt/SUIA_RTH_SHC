...
export const PATCH = withLogging(patchHandler, { component: 'admin', operation: 'update_subject' });
export const DELETE = withLogging(deleteHandler, { component: 'admin', operation: 'delete_subject' });
