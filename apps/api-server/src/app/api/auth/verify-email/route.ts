...
import { resolveRequestBrand, type RequestBrand } from '@/lib/request-brand';
...
async function handler(req: NextRequest) {
  try {
    ...
    const brand = body.brand ?? body.platform ?? resolveRequestBrand(req.nextUrl.hostname) ?? 'realtutorialhub';
