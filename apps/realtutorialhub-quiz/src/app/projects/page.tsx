  ...
  return (
    <div className="space-y-8">
      <div className="space-y-3">
        <h1 className="text-4xl font-black tracking-tight text-slate-900 uppercase">My Projects</h1>
        <p className="max-w-2xl text-sm font-medium leading-7 text-slate-500">
          Project work is shown in the learning experience once you open a subtopic. This page exists so the sidebar route is valid.
        </p>
      </div>
      ...
      <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">
          The actual project submission flow runs inside the tutorial app for the selected topic. Use the Knowledge Hub to continue there.
        </p>
