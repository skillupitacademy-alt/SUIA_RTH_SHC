...
export function TopicChip({
    ...
    return (
        <button
            onClick={() => onToggle(id)}
            className={cn(
                "flex flex-col items-start justify-center p-6 rounded-[1.25rem] transition-all duration-300 w-full h-[140px] text-left border-2 outline-none relative overflow-hidden",
                isSelected
