        ...
        <div className="space-y-20 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20">
            ...
            <section>
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">
                        Infrastructure Spec <span className="text-[#FF4B91] font-medium not-italic text-sm tracking-[0.2em] ml-4">(Vercel Monorepo)</span>
                    </h2>
                </div>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {INFRA_DATA.deployment.map((item, idx) => (
                                <tr key={idx} className="group hover:bg-slate-50 transition-colors">
                                    <td className="px-10 py-6 font-black text-slate-700 text-sm italic">{item.project}</td>
            ...
            <section>
                <div className="flex items-center gap-4 mb-8">
                    <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                    <h2 className="text-3xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">
                        Config Inventory <span className="text-[#FF4B91] font-medium not-italic text-sm tracking-[0.2em] ml-4">(Stability Keys)</span>
                    </h2>
                </div>
                <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                    <table className="w-full divide-y divide-slate-100">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {INFRA_DATA.configInventory.map((item, idx) => (
                                <tr key={idx} className="group hover:bg-slate-50 transition-colors">
                                    ...
                                    <td className="px-10 py-6 font-bold text-slate-500 text-sm italic">{item.purpose}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <section>
                <div className="flex items-center gap-4 mb-8">
                    <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                    <h2 className="text-3xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">
                        Environment Rules <span className="text-[#FF4B91] font-medium not-italic text-sm tracking-[0.2em] ml-4">(Auto-Detection)</span>
                    </h2>
                </div>
                <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
