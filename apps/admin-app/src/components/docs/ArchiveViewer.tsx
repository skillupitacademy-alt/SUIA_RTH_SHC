    ...
    useEffect(() => {
        const fetchContent = async () => {
            ...
            try {
                ...
                clientLogger.error('Failed to fetch archive content', { error: error instanceof Error ? error.message : 'unknown' });
                setError('Failed to load the archived intelligence file.');
