                            ...
                            <tbody className="divide-y divide-slate-100">
                                {ADMIN_SPEC_DATA.modules.map((item, idx) => (
                                    <tr key={idx} className="group hover:bg-slate-50 transition-colors">
                                        <td className="px-10 py-6 font-black text-slate-700 text-sm italic">{item.module}</td>
                        ...
                        <table className="w-full divide-y divide-slate-100">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {CORE_SPEC_DATA.authServices.map((item, idx) => (
                                    <tr key={idx} className="group hover:bg-slate-50 transition-colors">
                                        <td className="px-10 py-6 font-black text-slate-700 text-sm italic">{item.service}</td>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {UX_SPEC_DATA.breakpoints.map((item, idx) => (
                                    <tr key={idx} className="group hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="px-10 py-6 font-black text-slate-700 italic text-xs uppercase tracking-tight">{item.usage}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                ...
                {type === 'admin' && (
                    <>
                        <section>
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">Auth Strategy</h2>
                            </div>
                            <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">Recovery Flow</h2>
                            </div>
                            <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                                <div className="divide-y divide-slate-100">
                ...
                {type === 'core' && (
                    <>
                        <section>
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">Blueprint Rules</h2>
                            </div>
                            <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                                <div className="divide-y divide-slate-100">
                                    {CORE_SPEC_DATA.blueprintRules.map((item, idx) => (
                                        <div key={idx} className="px-10 py-6 hover:bg-slate-50 transition-colors">
                                            ...
                                            <div className="text-sm font-bold text-slate-600 italic font-mono">{item.value}</div>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">Nav Enforcement</h2>
                            </div>
                            <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                                <div className="divide-y divide-slate-100">
                                    {CORE_SPEC_DATA.navigationEnforcement.map((item, idx) => (
                                        <div key={idx} className="px-10 py-6 hover:bg-slate-50 transition-colors flex gap-6 items-start">
                                            ...
                                            <div>
                                                <div className="text-sm font-black text-slate-700 uppercase italic tracking-tight">{item.hook}</div>
                ...
                {type === 'ux' && (
                    <>
                        <section>
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">Interaction States</h2>
                            </div>
                            <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                                <div className="divide-y divide-slate-100">
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-1.5 h-8 bg-[#FF4B91] rounded-full" />
                                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tighter uppercase italic">Component Specs</h2>
                            </div>
                            <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/5 w-full">
                                <div className="divide-y divide-slate-100">
                                    {UX_SPEC_DATA.componentStandards.map((item, idx) => (
                                        <div key={idx} className="px-10 py-6 hover:bg-slate-50 transition-colors flex gap-6 items-start">
                                            <div className="w-1.5 h-10 bg-slate-100 shrink-0" />
                                            <div>
                                                <div className="text-sm font-black text-slate-700 uppercase italic tracking-tight">{item.component}</div>
