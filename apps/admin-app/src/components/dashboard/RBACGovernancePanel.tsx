    ...
    return (
        <div className="p-10 rounded-[3.5rem] border border-primary/10 bg-muted/5 backdrop-blur-md shadow-sm h-full">
            <div className="flex items-center justify-between mb-10">
                <div>
                    <h3 className="text-3xl font-black uppercase tracking-tighter italic text-[#1A1A1A]">RBAC Governance</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mt-1">Privilege Allocation & Role distribution</p>
                </div>
            ...
            <div className="space-y-6">
                {roles.map((r) => (
                    <div key={r.role} className="flex items-center justify-between p-6 rounded-[2rem] bg-background border border-muted/50 group hover:border-primary/20 transition-all">
                        ...
                        <div className="flex items-center gap-3">
                            <span className="text-2xl font-black tracking-tighter text-[#1A1A1A]">{r.count}</span>
                            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest leading-none">Users<br />Assigned</span>
                        </div>
                    </div>
                ))}
            </div>
