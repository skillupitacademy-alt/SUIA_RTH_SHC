        ...
        <div className="space-y-4">
            ...
            <div className="bg-white/50 backdrop-blur-xl border border-primary/10 p-6 rounded-[2rem] shadow-xl relative overflow-hidden flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                    <div className="p-2 rounded-xl bg-yellow-50 text-yellow-500 shadow-sm border border-yellow-100">
                    ...
                    <div className="relative flex-1 max-w-md group">
                        <input
                            ...
                            className="w-full bg-slate-50 border-none rounded-2xl px-5 py-3 text-[11px] font-black tracking-widest text-[#1A1A1A] placeholder:text-slate-300 focus:ring-2 focus:ring-yellow-500/10 transition-all outline-none border border-transparent shadow-inner"
                        />
                ...
                {isLoading && (
                    <div className="absolute inset-0 z-10 bg-white/60 backdrop-blur-sm flex items-center justify-center">
                        <div className="flex flex-col items-center gap-3">
                            <div className="w-10 h-10 border-4 border-yellow-50 border-t-yellow-500 rounded-full animate-spin" />
