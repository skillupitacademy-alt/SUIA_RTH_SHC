...
export function SubjectTable() {
    ...
    useEffect(() => {
        const fetchSubjects = async () => {
            try {
                const response = await apiClient.admin.getSubjects(page, 20);
    ...
    if (isLoading) return <div className="text-center py-20 text-muted-foreground animate-pulse">Loading Subjects...</div>;
