                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2 col-span-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Topic Name</label>
                                    <input
                                        required
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Parent Subject</label>
                                    <select
                                        required
                                        disabled={!formData.domainId}
                                        value={formData.subjectId}
                                        onChange={(e) => setFormData({ ...formData, subjectId: e.target.value })}
                                        className="w-full bg-slate-50 border-none rounded-2xl px-5 py-3 text-sm font-bold text-[#1A1A1A] focus:ring-2 focus:ring-[#FF4B91]/20 outline-none appearance-none cursor-not-allowed disabled:opacity-50"
                                    >
                                ...
                                <div className="space-y-2 col-span-2">
                                    ...
                                    <textarea
                                        rows={3}
                                        placeholder="Provide topic context..."
