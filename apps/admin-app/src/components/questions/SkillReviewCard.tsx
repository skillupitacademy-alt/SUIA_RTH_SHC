...
interface SkillReviewCardProps {
    ...
    onDeleteRequest: (skill: any) => void;
    onEditRequest: (skill: any) => void;
}
...
export function SkillReviewCard({
    ...
    return (
        <div className={cn(
            ...
            {isSelected && (
                <div className="absolute inset-0 bg-cyan-500/[0.02] pointer-events-none animate-in fade-in duration-500" />
            )}
