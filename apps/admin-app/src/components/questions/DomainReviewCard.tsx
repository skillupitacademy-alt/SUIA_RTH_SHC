...
import {
    Edit2, Trash2, Globe, Clock, Layers, BookOpen
} from 'lucide-react';
...
export function DomainReviewCard({
    ...
    return (
        <div className={cn(
            ...
            {isSelected && (
                <div className="absolute inset-0 bg-blue-500/[0.02] pointer-events-none animate-in fade-in duration-500" />
            )}
            ...
            <div className="px-8 py-5 border-b border-slate-100 flex flex-wrap items-center justify-between gap-4 bg-slate-50/50">
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-[10px] font-bold text-slate-300 mt-0.5">DID: {domain.id}</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    <div className={cn(
                        ...
                        <div className={cn("w-1 h-1 rounded-full", domain.status === 'active' ? "bg-emerald-500 animate-pulse" : "bg-slate-400")} />
                        {domain.status}
                    </div>
                    ...
                    <button
                        ...
                        className="p-2.5 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-blue-500 hover:border-blue-500/20 transition-all active:scale-95 shadow-sm"
                        title="Edit Domain"
                    >
                        <Edit2 size={14} />
                    </button>
