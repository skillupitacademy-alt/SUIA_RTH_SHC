...
const REFRESH_URL = 'https://api.skillupitacademy.com/api/auth/refresh';
...
export function PlacementBridgeClient({ redirectTarget }: PlacementBridgeClientProps) {
  const [message, setMessage] = useState('Connecting your SkillUp session to shared placement...');
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(14,165,233,0.18),transparent_28%),linear-gradient(180deg,#f3fbff_0%,#ffffff_58%)] px-6 py-10">
      <div className="mx-auto max-w-2xl rounded-[36px] border border-cyan-100 bg-white p-8 text-center shadow-[0_30px_80px_rgba(14,165,233,0.12)] sm:p-10">
        <p className="text-sm font-bold uppercase tracking-[0.35em] text-cyan-600">Placement Bridge</p>
