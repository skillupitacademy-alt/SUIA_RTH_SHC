...
export const ProjectWireframe: React.FC<WireframeProps> = ({
  selectedSectionId,
  selectedSubsectionId,
  highlightedElement,
  handleSectionChange,
}) => {
  if (selectedSectionId !== 'project') return null;
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
        ...
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/60 relative flex flex-col gap-2">
          ...
          <div className="h-16 bg-slate-200 border border-dashed border-slate-300 rounded flex items-center justify-center text-[9px] text-slate-550 font-bold">Phased roadmap SVG diagram</div>
        ...
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/60 relative flex flex-col gap-2">
          ...
          <div className="h-16 bg-slate-200 border border-dashed border-slate-300 rounded flex items-center justify-center text-[9px] text-slate-550 font-bold">System layers blueprint SVG</div>
