      ...
      <section className="bg-white/80 backdrop-blur rounded-xl border-t border-white/60 shadow-2xl p-6 -translate-y-1 hover:-translate-y-3 transition-transform duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="space-y-1.5">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">{item.label}</label>
        ...
        <div className="mt-6 flex items-center justify-end">
          <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 px-4 py-2 rounded-xl">
            <span className="text-xs font-bold text-slate-400 uppercase">Subtopic ID</span>
            ...
            <table className="w-full text-left border-collapse text-xs font-medium text-slate-600">
              <thead className="bg-slate-50/80 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Changes</th>
                  <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Updated By</th>
                  <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Updated At</th>
                ...
                {[
                  ...
                  <tr key={i} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${row.status === 'Active' ? 'bg-emerald-50 text-emerald-600' : 'bg-slate-100 text-slate-500'}`}>
                        {row.status}
                      </span>
                    </td>
