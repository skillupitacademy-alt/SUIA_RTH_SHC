...
export const heroCommonData: HeroCommonData = {
  ...
  hiringCompanies: {
    ...
    companies: [
      { name: "TCS", logo: "/TSC.png", alt: "TCS Logo" },
      { name: "Wipro", logo: "/Wipro.png", alt: "Wipro Logo" },
      { name: "Tech Mahindra", logo: "/TechMahindra.png", alt: "Tech Mahindra Logo" },
      { name: "Accenture", logo: "/Accenture.png", alt: "Accenture Logo" },
      { name: "Capgemini", logo: "/Capgemini.png", alt: "Capgemini Logo" },
      { name: "HCL", logo: "/HCL.png", alt: "HCL Logo" },
      { name: "Cognizant", logo: "/Cognizant.png", alt: "Cognizant Logo" },
    ]
  }
};
...
export const allCourses: Course[] = [
      ...
      techStack: [
        {
          ...
          technologies: [
            ...
            { label: "SQL", iconSrc: "/DAT2.png" },
            { label: "Excel", iconSrc: "/DAT3.webp" },
            { label: "Statistics", iconSrc: "/DAT4.png" },
            { label: "Pandas", iconSrc: "/DAT5.png" },
        ...
        },
        {
          ...
          technologies: [
            { label: "Tableau", iconSrc: "/VT1.png" },
            { label: "Power BI", iconSrc: "/VT2.png" },
            { label: "Matplotlib", iconSrc: "/VT3.svg" },
            { label: "Seaborn", iconSrc: "/VT4.png" },
            { label: "Plotly", iconSrc: "/VT5.png" },
            { label: "Dash", iconSrc: "/VT6.png" }
          ]
        },
        {
          ...
          technologies: [
            { label: "MySQL", iconSrc: "/DD1.png" },
            { label: "PostgreSQL", iconSrc: "/DC2.png" },
            { label: "MongoDB", iconSrc: "/DC3.png" },
            { label: "AWS", iconSrc: "/DC4.png" },
            { label: "Google Cloud", iconSrc: "/DC5.png" },
            { label: "Azure", iconSrc: "/DC6.png" }
          ]
        },
        {
          ...
          technologies: [
            { label: "Scikit-learn", iconSrc: "/ML1.png" },
            { label: "TensorFlow", iconSrc: "/ML2.webp" },
            { label: "PyTorch", iconSrc: "/ML3.png" },
            { label: "NLTK", iconSrc: "/ML4.png" },
  ...
  },
  {
    ...
    image: "/T.png", // You'll need to create/use this image
      ...
      techStack: [
        {
          ...
          bgColor: "bg-gradient-to-r from-blue-50 to-indigo-50",
          technologies: [
            { label: "Python", iconSrc: "/DAT1.png" },
            { label: "NumPy", iconSrc: "/DAT6.png" },
            { label: "Pandas", iconSrc: "/DAT5.png" },
        ...
        },
        {
          ...
          technologies: [
            { label: "TensorFlow", iconSrc: "/ML2.webp" },
            { label: "PyTorch", iconSrc: "/ML3.png" },
            { label: "Keras", iconSrc: "/MLF3.png" },
            { label: "XGBoost", iconSrc: "/MLF4.webp" },
            { label: "LightGBM", iconSrc: "/MLF5.png" },
            { label: "CatBoost", iconSrc: "/MLF6.png" }
          ]
        },
        {
          ...
          technologies: [
            { label: "MySQL", iconSrc: "/DD1.png" },
            { label: "Docker", iconSrc: "/DD4.png" },
            { label: "Kubernetes", iconSrc: "/DP3.png" },
            { label: "Streamlit", iconSrc: "/Data4.png" },
            { label: "AWS SageMaker", iconSrc: "/CP1.png" },
            { label: "MLflow", iconSrc: "/AI1.png" }
          ]
        },
        {
          ...
          bgColor: "bg-gradient-to-r from-orange-50 to-amber-50",
          technologies: [
            { label: "OpenAI", iconSrc: "/AI1.png" },
            { label: "Hugging Face", iconSrc: "/AI2.png" },
            { label: "LangChain", iconSrc: "/AI3.png" },
            { label: "Transformers", iconSrc: "/AI4.png" },
            { label: "TensorBoard", iconSrc: "/AI5.png" },
            { label: "FastAPI", iconSrc: "/AI6.png" }
          ]
        }
      ],
      ...
      techStack: [
        {
          ...
          bgColor: "bg-gradient-to-r from-blue-50 to-indigo-50",
          technologies: [
            { label: "Java", iconSrc: "/BT1.png" },
            { label: "Spring Boot", iconSrc: "/BT2.png" },
            { label: "Spring Security", iconSrc: "/BT3.png" },
            { label: "Hibernate & JPA", iconSrc: "/BT4.png" },
            { label: "Maven/Gradle", iconSrc: "/BT5.png" },
            { label: "REST APIs", iconSrc: "/BT6.png" }
          ]
        },
        {
          ...
          bgColor: "bg-gradient-to-r from-purple-50 to-violet-50",
          technologies: [
            { label: "HTML5", iconSrc: "/FT1.png" },
            { label: "CSS3", iconSrc: "/FT2.png" },
            { label: "JavaScript", iconSrc: "/FT3.png" },
            { label: "React.js", iconSrc: "/FT4.png" },
            { label: "Redux/Context", iconSrc: "/FT5.png" },
            { label: "MUI/Tailwind", iconSrc: "/FT6.png" }
          ]
        },
        {
          ...
          technologies: [
            { label: "MySQL", iconSrc: "/DD1.png" },
            { label: "PostgreSQL", iconSrc: "/DD2.png" },
            { label: "MongoDB", iconSrc: "/DD3.png" },
            { label: "Docker", iconSrc: "/DD4.png" },
            { label: "Kubernetes", iconSrc: "/DD5.png" },
            { label: "AWS", iconSrc: "/DD6.png" },
        ...
        },
        {
          ...
          technologies: [
            { label: "OpenAI", iconSrc: "/AI1.png" },
            { label: "Hugging Face", iconSrc: "/AI2.png" },
            { label: "LangChain4j", iconSrc: "/AI3.png" },
            { label: "Vector DBs", iconSrc: "/AI4.png" },
            { label: "RAG Architecture", iconSrc: "/AI5.png" },
            { label: "DeepLearning4j", iconSrc: "/AI6.png" }
          ]
        }
      ],
      careerOutcomes: [
      ...
      techStack: [
        {
          ...
          bgColor: "bg-gradient-to-r from-blue-50 to-indigo-50",
          technologies: [
            { label: "Python 3.10+", iconSrc: "/BT1.png" },
            { label: "Django", iconSrc: "/BT2.png" },
            { label: "FastAPI", iconSrc: "/BT3.png" },
            { label: "SQL Alchemy", iconSrc: "/BT4.png" },
            { label: "pytest & unittest", iconSrc: "/BT5.png" },
            { label: "REST APIs", iconSrc: "/BT6.png" }
          ]
        },
        {
          ...
          technologies: [
            { label: "HTML5", iconSrc: "/FT1.png" },
            { label: "CSS3", iconSrc: "/FT2.png" },
            { label: "JavaScript ES6+", iconSrc: "/FT3.png" },
            { label: "React.js", iconSrc: "/FT4.png" },
            { label: "Redux/Context API", iconSrc: "/FT5.png" },
            { label: "Material UI / Tailwind", iconSrc: "/FT6.png" }
          ]
        },
        {
          category: "Database & DevOps",
          ...
          technologies: [
            ...
            { label: "MySQL", iconSrc: "/DD1.png" },
            { label: "MongoDB", iconSrc: "/DC3.png" },
            { label: "Redis", iconSrc: "/CP6.png" },
            { label: "Docker", iconSrc: "/DD4.png" },
            { label: "Kubernetes", iconSrc: "/DD5.png" },
            { label: "AWS Cloud", iconSrc: "/DD6.png" },
            { label: "Git & GitHub", icon: "GitBranch" }
          ]
        },
        {
          ...
          bgColor: "bg-gradient-to-r from-orange-50 to-amber-50",
          technologies: [
            { label: "OpenAI GPT-4", iconSrc: "/AI1.png" },
            { label: "Hugging Face", iconSrc: "/AI2.png" },
            { label: "LangChain", iconSrc: "/AI3.png" },
            { label: "Vector Databases", iconSrc: "/AI4.png" },
            { label: "RAG Architecture", iconSrc: "/AI5.png" },
            { label: "TensorFlow/PyTorch", iconSrc: "/AI6.png" }
          ]
        }
      ],
      careerOutcomes: [
      ...
      techStack: [
        {
          ...
          bgColor: "bg-gradient-to-r from-blue-50 to-indigo-50",
          technologies: [
            { label: "Python", iconSrc: "/BDT1.png" },
            { label: "Apache Spark", iconSrc: "/BDT2.png" },
            { label: "Hadoop", iconSrc: "/BDT2.png" },
            { label: "Apache Kafka", iconSrc: "/BDT3.png" },
        ...
        },
        {
          ...
          bgColor: "bg-gradient-to-r from-purple-50 to-violet-50",
          technologies: [
            { label: "AWS", iconSrc: "/CP1.png" },
            { label: "Google Cloud", iconSrc: "/CP2.png" },
            { label: "Azure", iconSrc: "/CP3.png" },
            { label: "Databricks", iconSrc: "/CP4.webp" },
            { label: "Snowflake", iconSrc: "/CP5.png" },
            { label: "Redshift", iconSrc: "/CP6.png" }
          ]
        },
        {
          ...
          bgColor: "bg-gradient-to-r from-green-50 to-emerald-50",
          technologies: [
            { label: "PostgreSQL", iconSrc: "/DDW1.png" },
            { label: "MySQL", iconSrc: "/DD1.png" },
            { label: "MongoDB", iconSrc: "/DC3.png" },
            { label: "Cassandra", iconSrc: "/DDW4.png" },
            { label: "BigQuery", iconSrc: "/DDW5.svg" },
            { label: "Synapse", iconSrc: "/DDW6.png" }
          ]
        },
        {
          ...
          bgColor: "bg-gradient-to-r from-orange-50 to-amber-50",
          technologies: [
            { label: "dbt", iconSrc: "/DP1.png" },
            { label: "Docker", iconSrc: "/DP2.png" },
            { label: "Kubernetes", iconSrc: "/DP3.png" },
            { label: "TensorFlow", iconSrc: "/ML2.webp" },
            { label: "PyTorch", iconSrc: "/ML3.png" },
            { label: "Apache Beam", iconSrc: "/DP6.png" }
          ]
        }
      ],
      careerOutcomes: [
