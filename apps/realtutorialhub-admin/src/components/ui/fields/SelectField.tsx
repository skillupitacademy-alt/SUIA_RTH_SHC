    ...
    return (
        <div className="space-y-1.5 w-full">
            ...
            <div className="relative">
                <select
                    {...props}
                    disabled={props.disabled === true || isLoading === true}
                    className={`
                        ...
                        ${(error != null && error !== '') ? 'border-rose-300 focus:border-rose-500 focus:ring-rose-500/20' : ''}
                        ${(className != null && className !== '') ? className : ''}
                    `}
                >
                    <option value="" disabled selected={props.value == null || props.value === ''}>
                        {(props.placeholder != null && props.placeholder !== '') ? props.placeholder : "Select option..."}
                    </option>
                    {options.map((opt) => (
