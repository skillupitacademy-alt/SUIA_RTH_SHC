...
export function AssessmentSummary({
    ...
    return (
        <aside className="w-full flex flex-col h-full">
            <div className="glass-morphism pink-glow rounded-[2.5rem] p-8 space-y-6 relative overflow-hidden group transition-all duration-500 hover:shadow-[0_0_50px_rgba(255,45,85,0.15)] flex-1 flex flex-col">
                {/* Visual Aura */}
                ...
                <div className="relative z-10 flex-1 flex flex-col h-full">
                    ...
                    <div className="space-y-8 flex-1">
                        <div className="flex flex-col gap-2">
                            ...
                            <span className="text-base font-bold font-inter text-[#1A1A1A] pl-7 truncate">{domainName}</span>
                        </div>
