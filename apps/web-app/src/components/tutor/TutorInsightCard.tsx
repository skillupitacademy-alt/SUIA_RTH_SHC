        ...
        <div className="bg-white border border-slate-200 rounded-[2rem] p-8 shadow-sm hover:shadow-xl hover:border-orange-500/20 transition-all duration-500 overflow-hidden relative group">
            ...
            <div className="space-y-3">
                {recommendations.map((item) => (
                    <div
                        key={item.topicName}
                        className="p-5 rounded-2xl bg-slate-50/50 border border-slate-100 hover:border-orange-500/20 hover:bg-white hover:shadow-lg transition-all duration-300 group/card"
                    >
