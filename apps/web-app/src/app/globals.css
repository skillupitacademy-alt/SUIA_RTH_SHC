...
@font-face {
  ...
  font-weight: 600;
  font-display: swap;
  src: url('/fonts/QGYyz_MVcBeNP4NjuGObqx1XmO1I4e6yC4E.ttf') format('truetype');
}
...
@font-face {
  ...
  font-weight: 800;
  font-display: swap;
  src: url('/fonts/QGYyz_MVcBeNP4NjuGObqx1XmO1I4bCyC4E.ttf') format('truetype');
}
...
@font-face {
  ...
  font-weight: 900;
  font-display: swap;
  src: url('/fonts/QGYyz_MVcBeNP4NjuGObqx1XmO1I4ZmyC4E.ttf') format('truetype');
}
...
/* 
 * ==========================================
 * HIGH-FIDELITY PDF GRID SYSTEM
 * ==========================================
 */

/* Force exact colors for all view modes */
* {
...
/* BRUTE-FORCE ANIMATION LOCKDOWN */
.pdf-root * {
...
.pdf-page {
  ...
  /* Tightened from 48px to reduce squeezing */
  margin: 0 !important;
...
/* Modal/Overlay Eraser */
.pdf-container .no-print,
.pdf-container nav,
.pdf-container header:not(.pdf-header),
.pdf-container footer:not(.pdf-footer),
.pdf-container [data-modal],
.pdf-container .modal,
.pdf-container .overlay,
.pdf-container .backdrop,
.pdf-container [id*="session-expired"] {
...
.chart-print-lock canvas,
.chart-print-lock .recharts-surface {
  width: 100% !important;
