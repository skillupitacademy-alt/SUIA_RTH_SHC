...
export default function ExamError({
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Something went wrong during your exam</h2>
            <p className="text-gray-500 mb-8 max-w-md">
                Your progress has been saved. You can try resuming or return to the dashboard.
            </p>
