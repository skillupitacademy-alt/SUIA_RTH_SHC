...
const BRANDS = [
  {
    ...
    email: requiredEnv('AUTH_DIAGNOSTIC_RTH_EMAIL'),
    password: requiredEnv('AUTH_DIAGNOSTIC_RTH_PASSWORD'),
  },
  {
    name: 'SkillUp',
    host: 'user.skillupitacademy.com',
    email: requiredEnv('AUTH_DIAGNOSTIC_SKILLUP_EMAIL'),
    password: requiredEnv('AUTH_DIAGNOSTIC_SKILLUP_PASSWORD'),
  },
];
