...
const SUIA_USER_ID = 'afc355ca-6bae-4165-89dd-198494a62f85';
...
(async () => {
  try {
    console.log('=== SUIA BLOCK VISIT VERIFICATION ===\n');
    console.log('Searching for block visit record:');
    console.log(`  userId: ${SUIA_USER_ID}`);
    ...
    const records = await db
      ...
      .where(
        and(
          eq(blockLearningState.userId, SUIA_USER_ID),
