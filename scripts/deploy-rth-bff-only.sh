...
gcloud run deploy $SERVICE_RTH \
  ...
  --max-instances 10 \
  --min-instances 0 \
  --set-env-vars "INTERNAL_API_URL=${INTERNAL_API_URL},GATEWAY_URL=https://api.realtutorialhub.com,GATEWAY_URL_SKILLUP=https://api.skillupitacademy.com,NODE_ENV=production" \
