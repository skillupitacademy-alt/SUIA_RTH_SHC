...
- Phase F1 kickoff: installed Pino deps (pino, pino-http, pino-pretty) for @quiz/api-server in prep for structured logging wiring. No code changes yet. 9d17205 (docs: note deferred smoke tests for e2 flows)
