...
- Phase F1 kickoff: installed Pino deps (pino, pino-http, pino-pretty) for @quiz/api-server in prep for structured logging wiring. No code changes yet. 73111e8 (docs: prep notes for phase e4 memoization audit)
