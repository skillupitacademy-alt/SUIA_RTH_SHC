...
- Phase F1 kickoff: installed Pino deps (pino, pino-http, pino-pretty) for @quiz/api-server in prep for structured logging wiring. No code changes yet. 2252dde (docs: capture E4 memoization timing and rationale)
