...
- Phase F1 kickoff: installed Pino deps (pino, pino-http, pino-pretty) for @quiz/api-server in prep for structured logging wiring. No code changes yet. 86333b2 (docs: log e3 next-image audit (no changes))
